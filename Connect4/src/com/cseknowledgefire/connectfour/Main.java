...
public class Main extends Application {
	...
	private void aboutMe() {
		...
		alert.setHeaderText("Ritik Kumar");
		alert.setContentText("I love to play around with code and to create apps,websites and  games. " +
				"Connect4 is one of them. In free time " +
				"I like to explore more with books and Web and I am also a quick learner.");
		alert.show();
	}
